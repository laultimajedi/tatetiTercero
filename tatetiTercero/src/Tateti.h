...
private:
	Tablero* tablero;
	Cola<Jugador*>* turnos;
	Pila<Tablero*>* historialTableros;
	Jugador** jugadores;
public:
	/*PRE:-
	...
	*/
	bool movimientoValido(int x1, int y1, int z1, int x2, int y2, int z2, Jugador* actual);
	/*PRE:-
	...
	*/
	...
	/*
	 * PRE:-
	 * POST: Devuelve el mayor numero de los tres numeros pasados por parametros*/

	int dimensionMayor(int x, int y, int z);
